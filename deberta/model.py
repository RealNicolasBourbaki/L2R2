...
DEBERTA_PRETRAINED_MODEL_ARCHIVE_MAP = {
    'deberta-base': "https://huggingface.co/microsoft/deberta-base/resolve/main/pytorch_model.bin",
    'deberta-large': "https://huggingface.co/microsoft/deberta-large/resolve/main/pytorch_model.bin",
}
...
class DebertaForListRank(BertPreTrainedModel):
