...
from transformers import BertConfig, BertTokenizer, RobertaConfig, RobertaTokenizer, DebertaConfig, DebertaTokenizer
from transformers import BERT_PRETRAINED_CONFIG_ARCHIVE_MAP, ROBERTA_PRETRAINED_CONFIG_ARCHIVE_MAP, DEBERTA_PRETRAINED_CONFIG_ARCHIVE_MAP

from model import BertForListRank, RobertaForListRank, DebertaForListRank
...
ALL_MODELS = sum(
    (tuple(conf.keys()) for conf in (BERT_PRETRAINED_CONFIG_ARCHIVE_MAP, ROBERTA_PRETRAINED_CONFIG_ARCHIVE_MAP, DEBERTA_PRETRAINED_CONFIG_ARCHIVE_MAP)),
    ())
